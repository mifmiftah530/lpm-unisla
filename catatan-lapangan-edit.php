                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form action="" method="POST">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" name="temuan" class="form-control" id="temuan" value="<?= $rowTemuan['TEMUAN']; ?>">
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label for="kts" class="form-label">KTS/OB</label>
                                                                            <input type="text" name="kts" class="form-control" id="kts" value="<?= $rowTemuan['KTS']; ?>">
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label for="akarmasalah" class="form-label">Akar Masalah</label>
                                                                            <input type="text" name="akarmasalah" class="form-control" id="akarmasalah" value="<?= $rowTemuan['AKAR_PERMASALAHAN']; ?>">
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label for="rekomendasi" class="form-label">Rekomendasi</label>
                                                                            <input type="text" name="rekomendasi" class="form-control" id="rekomendasi" value="<?= $rowTemuan['REKOMENDASI']; ?>">
                                                                        </div>
