                                ...
                                if (mysqli_num_rows($kriteria) > 0) {
                                    while ($row = mysqli_fetch_array($kriteria)) {
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo $row['ID_AUDITOR'] . 'Nama Tidak Tersedia'; ?></td>
                                            <td align="center" style="width: 135px;">
                                            <button type="button" class="btn btn-success"> <a href="auditor-tersedia.php?id=<?php echo $row['UNIT']; ?>" style=" color: white; text-decoration: none;">Mulai Audit</a></button><br>
                                            <button type="button" class="btn btn-primary mt-2"> <a href="auditor-tersedia.php?id=<?php echo $row['UNIT']; ?>" style=" color: white; text-decoration: none;">Peta Mutu</a></button>
