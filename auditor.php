                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <a href="auditor-tersedia.php?id=<?php echo $row['UNIT']; ?>" class="btn btn-success"><i class="fas fa-play"></i> Mulai Audit</a>
                                                <a href="peta-mutu-auditor.php?id=<?php echo $row['UNIT']; ?>" class="btn btn-primary mt-2"><i class="fas fa-map"></i> Peta Mutu</a>


                                            </td>
                                            <td style="width: 60px;">
                                                <button <a href="form-auditor.php?id=<?php echo $row['UNIT']; ?>"
