                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td align="center" style="width: 135px;">
                                                ...
                                                <a href="grafikauditor.php" class="btn btn-primary mt-2"><i class="fas fa-map"></i> Peta Mutu</a>


                                            </td>
                                            <td style="width: 60px;">
                                                <button <a href="form-auditor.php?id=<?php echo $row['UNIT']; ?>" class="btn btn-warning">
