                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="profil-auditor.php">
                            ...
                            <?php echo isset($_SESSION['a_global']->NAMA) ? htmlspecialchars($_SESSION['a_global']->NAMA) : 'Nama Tidak Tersedia'; ?>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Selamat Datang <?php echo htmlspecialchars($_SESSION['a_global']->NAMA); ?></h5>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Anak Ti ni boss</div>
                        <div>
